...
// Icons
import { AlertCircle, ArrowLeft, Send, CheckCircle, Upload } from "lucide-react";
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-6 animate-in zoom-in-50 duration-500">
                ...
                <div className="text-center space-y-2">
                    <h2 className="text-2xl font-black uppercase tracking-tight">Report Received</h2>
                    <p className="text-muted-foreground max-w-sm">
                        Thank you for bringing this to our attention. Our safety team will review your report and take appropriate action within 24 hours.
                    </p>
                </div>
                <Button onClick={() => navigate(-1)} className="bg-primary text-primary-foreground font-bold uppercase text-xs h-12 px-8 rounded-xl">
                    Return to Dashboard
                </Button>
            </div>
        );
            ...
            <Card className="border-border bg-card rounded-[2.5rem] overflow-hidden shadow-2xl">
                <CardHeader className="p-10 pb-0">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                             <CardTitle className="text-2xl font-black uppercase tracking-tight">Submit Incident Report</CardTitle>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={setCategory} value={category}>
                                <SelectTrigger className="h-14 rounded-2xl bg-muted/30 border-border font-bold">
                                    <SelectValue placeholder="Select a reason..." />
                                </SelectTrigger>
                                <SelectContent>
                                    <SelectItem value="payment_off_platform">Asked to pay outside platform</SelectItem>
                                    <SelectItem value="harassment">Harassment or abusive behavior</SelectItem>
                                    <SelectItem value="scam">Suspicious activity / Scam</SelectItem>
                                    <SelectItem value="no_show">Did not show up / Incomplete work</SelectItem>
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea 
                                ...
                                className="min-h-[150px] rounded-2xl bg-muted/30 border-border font-medium p-4 resize-none"
                                value={description}
                        ...
                        <div className="space-y-2">
                            <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ml-1">Supporting Evidence (Optional)</Label>
                            <div className="border-2 border-dashed border-border rounded-2xl p-8 flex flex-col items-center justify-center text-center hover:bg-muted/30 transition-colors cursor-pointer relative">
                                ...
                                <span className="text-xs font-bold text-muted-foreground">{evidence ? evidence.name : "Click to upload screenshots"}</span>
                                <input 
                                    type="file" 
