...
const ChatBox = () => {
  ...
  const handleScheduleSubmit = async () => {
    ...
    try {
      ...
      handleSendMessage(`Appointment Proposed: ${displayDate}`, "appointment", {
        appointmentId,
      ...
      >
        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 2 }}>
          <Typography variant="h6">
            Private Chat {isArchived && "(Closed)"}
          </Typography>
          ...
          <List>
            {messages.map((msg, i) => (
              <ListItem
                ...
                sx={{
                  flexDirection:
                    msg.sender?._id === user.id ? "row-reverse" : "row",
                }}
              >
                ...
                <Paper
                  sx={{
                    p: 1,
                    bgcolor:
                      msg.sender?._id === user.id ? "#e3f2fd" : "#f5f5f5",
                  }}
                >
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          <TextField
            ...
            placeholder={
              isArchived
                ? "This job has been completed/closed."
                : "Type a message..."
            }
